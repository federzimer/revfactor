...
## What AI actually cites on YouTube (the winning formula)
The top-cited YouTube URLs for RevFactor's prompts are almost all **revenue-maximization and pricing** content, from a handful of creators. The pattern is clear:

| Cited video | Creator | Citations |
|---|---|--:|
| How to add **$130,000** to your Airbnb revenue (copy what I did) | Optimize My Airbnb | 27 |
| **10 Proven Ways** to Earn More with Your Short-Term Rental | Short Term Rental Riches | 26 |
| **11 Ways to 3X** Your Airbnb Income (Complete Host Guide) | James Svetec | 24 |
| How To **Charge The Best Prices** For Airbnb (Short) | Inayah McMillan | 23 |
| **10 Ways to Charge MORE** on Airbnb (I Quadrupled My Revenue) | Optimize My Airbnb | 22 |
| The **BEST Airbnb Pricing Tool** 2025 / Just Got 100x Better | James Svetec | 15–19 |

**The formula AI rewards:** number-led titles ("10 Ways…", "11 Ways to 3X…"), a **concrete revenue outcome** ("$130K", "quadrupled", "3X"), and **pricing or pricing-tool** framing. Long-form guides and Shorts both earn citations. This is Fede's wheelhouse. He just isn't on YouTube yet.

## Our play: a RevFactor video for each top-cited format, and we already have the content
The brain has **144 transcribed clips**, and they map onto every cited format. Theme coverage today: **38 pricing/rate clips, 20 revenue clips (16 with a concrete $ figure), 42 occupancy/calendar, 39 comp-set/market, 29 review/ranking, 27 amenity/design, 13 pricing-tool, 12 revenue-manager-mindset**. We can answer each top-cited video with footage we already have, no filming required:

| Their top-cited video (format) | The RevFactor video we make | Built from (brain content we have) |
|---|---|---|
| "Add **$130K** to your Airbnb revenue (copy what I did)", 27 cites | **"How We Added $139K to 7 Airbnbs in One Summer (The Exact Playbook)"** (the flagship, see below) | Case-study data across 7 properties (+$139,580), plus 16 clips with concrete $ results |
| "**10 Proven Ways** to Earn More", 26 cites | **"10 Proven Ways to Earn More From Your Short-Term Rental (2026)"** | Compile 10 of the 38 pricing + 20 revenue + 27 amenity/design tactic clips |
| "**11 Ways to 3X** Your Airbnb Income", 24 cites | **"11 Ways to Grow Your Airbnb Income Without Buying Another Property"** | Same tactic pool + 29 review/ranking + 13 tool clips |
| "**Charge The Best Prices** (Short)", 23 cites | **Short: "The One Pricing Concept Pros Use That Hosts Don't"** (pacing/momentum) | The pacing/momentum clip ("price like a professional revenue manager") + 38 pricing clips |
| "**10 Ways to Charge MORE** (I Quadrupled Revenue)", 22 cites | **"10 Ways to Charge More on Airbnb in 2026 (Without Losing Bookings)"** | 38 pricing/charge clips + the "beat the market minimum" tactic + the Airbnb comp-data hack |
| "**BEST Airbnb Pricing Tool** 2025", 15–19 cites | **"The Best Airbnb Pricing Setup for 2026 (Tool + the Human Layer)"** | 13 dynamic-pricing/PriceLabs clips + comp-data hack + revenue-manager-mindset clips, reframing tool into tool-plus-strategist (RevFactor's wedge) |
...
| Market / type (anonymized) | On-the-books summer lift | Pacing vs last year |
|---|--:|--:|
| Gatlinburg cabin | +$47,459 | +220.7% |
| Lake Michigan lake house | +$23,419 | +189.1% |
| Myrtle Beach coastal | +$21,352 | +106.4% |
| Albion, MI waterfront | +$17,134 | +292.8% |
| San Diego bungalow | +$15,322 | +98.6% |
| Minneapolis home | +$9,356 | +101.3% |
| Norfolk inn | +$5,538 | +57.1% |
| **7 properties, total** | **+$139,580** | |

**Two cuts, both from data we already have:**
...
|---|---|---|
| **Job** | The human, authority, and E-E-A-T. The face buyers and AI trust | The brand entity citations attach to |
| **Owns (primary)** | The **podcast** (full episodes) plus his native vertical Shorts (as he already makes them) | Number-led compilation guides (Track B), case-study videos, and Shorts **cut from those** |
...
- **Long-form (podcast episodes, compilation guides, case-study videos): ONE home each, never re-uploaded to the other channel.** The full podcast lives on personal. The guides and case-study videos live on RevFactor. If the other channel should point at it, use a Community post or a short clip, not a duplicate full upload.
- **Shorts: each channel produces its own.** Only the occasional standout Short crosses over, and when it does it gets a **different hook, title, and thumbnail** and is **staggered a week or more**. Never a carbon copy posted the same day. (Low risk: the two audiences barely overlap yet, and Shorts are feed-distributed, not subscriber-fed.)
- **Podcast clips** are cut from the episode and posted natively to **RevFactor** (branded). Fede is free to post his own cuts on personal as different edits, not the same file.

## Channel setup
- **🔴 We don't name clients in our video framing.** Titles, thumbnails, and descriptions show results by market and property type only (e.g. "a Gatlinburg cabin"), no property nicknames, addresses, or owner names. *Exception: if Fede chooses to mention a client on camera, that's his call.*
- **RevFactor company channel:** brand handle @RevFactor, channel art and About using the canonical description ("done-for-you short-term rental revenue management"). Link revfactor.io and the discovery-call CTA.
...
- Host-vs-professional revenue management becomes **"What Pro Revenue Managers Do That Hosts Don't"**
- Seasonal cancellation-policy reel becomes **"The Cancellation Policy Trick That Earns You More"**
- Dynamic-pricing and calendar reels become **"How to Price Your Airbnb Calendar Like a Pro"**
...
- **Honest role:** the podcast's job is **(1) Shorts fuel, (2) brand, authority, and E-E-A-T, and (3) chaptered episodes that can earn citations on specific Q&A moments.** It does *not* replace Track B. The number-led guides stay the primary citation magnets. Fede's airline-revenue-management framing is distinctive and quotable, which is where the citation upside sits.

## Weekly cadence (so Jlo knows the target each week)
**Start small, prove the pipeline, then ramp.** Everything below comes from existing footage, with no dependency on Fede filming net-new (except the podcast, which he's already recording).

| Phase | Weeks | Shorts / week | Long-form | Podcast | Notes |
|---|---|--:|---|---|---|
| **Phase 1: Start small** | Now to wk 4 | **2–4** | 1 total (the $139K flagship cut) | EP.01 clips staged | Build the habit and the tracking-sheet rhythm. Learn what lands |
| **Phase 2: Ramp** | wk 5–8 | **4–5** | 1 every 2 wks | EP.01 live + clips | Add Track B compilation guides once Phase 1 Shorts prove out |
| **Phase 3: Scale** | wk 9–12 | **5–7** | 1 / wk | 1 episode + its clips | Re-pull Peec. Double down on the titles and topics actually earning citations |

**This week's concrete target for Jlo (Phase 1):** 2-4 Shorts from the 31-reel backlog (retitled to tracked Peec prompts), and start assembling the flagship **$139K, 7-property playbook** video (script in the separate doc). Cut, but don't publish, the 7 EP.01 Shorts. Log every item in the tracking sheet.

## The repurpose pipeline (so this is sustainable, not a one-off)
Fede already produces daily TikTok/IG. The brain transcribes it. The pipeline: **Fede's TikTok/IG feeds the brain (auto-transcribe), we pick the STR-tactic ones, post them as retitled YouTube Shorts, and batch the best into long-form guides.**

This depends on the brain-scan staying healthy. It had been silently broken since Jun 23 (TikTok downloads failing, no alerting). It's now fixed (impersonation dep installed) and moving to an always-on host with failure alerting so it can't silently die again. Inventory is current: 136 IG transcripts (via Apify) plus TikToks, no new posts pending.

## Targets (tie to the 90-day plan)
- Month 1 (Phase 1): both channels set up, **8-12 Shorts total** (2-4/wk from the backlog), **the $139K flagship video**, and EP.01's 7 Shorts cut and staged.
- Month 2-3 (Phase 2-3): ramp to 4-7 Shorts/wk, 1 long-form guide every 1-2 weeks, and 1 podcast episode with its clips. Re-pull Peec. Goal: **revfactor.io and youtube.com/@RevFactor both appearing** in the cited set for the revenue/pricing prompts.
- Success metric: RevFactor's own YouTube URLs start showing up in the Peec cited-URLs report (currently zero, the 25 cited URLs are all competitors and creators).
- **Everything tracked in the RevFactor YouTube Tracker sheet** (linked at top). Jlo logs each video's status, channel, source clip, title, tracked prompt, publish date, and Peec-cited check.
