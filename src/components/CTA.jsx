    ...
    <section ref={sectionRef} id="contact" className="bg-[#3F261F] py-20 md:py-28">
      <div className="max-w-4xl mx-auto px-6 md:px-12 text-center">
        ...
        <div className="cta-animate opacity-0">
          <button
            onClick={() => { window.posthog?.capture('schedule_modal_opened', { source: 'cta_section' }); window.rfTrack?.('schedule-cta-click', { source: 'cta-section', page: location.pathname }); setScheduleOpen(true); }}
