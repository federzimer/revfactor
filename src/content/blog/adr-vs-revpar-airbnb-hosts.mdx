---
title: "ADR vs RevPAR for Airbnb: What Each Means and Which One Pays You"
description: "ADR vs RevPAR, explained for Airbnb hosts: ADR (Average Daily Rate) is revenue divided by booked nights and measures pricing power. RevPAR (Revenue Per Available Room) is revenue divided by every available night, booked or empty. Two hosts at the same ADR can post a $43,800 annual gap, and only RevPAR sees it."
...
American Airlines essentially invented modern revenue management in the late 1970s. Robert Crandall, the American Airlines CEO who gave the discipline its name, called yield management "the single most important technical development in transportation management since we entered deregulation," according to [the documented history of yield management](https://en.wikipedia.org/wiki/Yield_management). Hotels institutionalized it. Cruise lines refined it. They figured out a long time ago that the price on a rate card means very little if you cannot tell me what is actually happening across the full inventory. STRs are still catching up to that basic discipline.
...
ADR feels like proof. It is one number that says *I am running a premium product*. Pricing tools like [PriceLabs](https://www.pricelabs.co/pricing), Beyond Pricing, and Wheelhouse all surface ADR by default on their dashboards, which is part of why hosts over-fixate on it. If the dashboard puts a number front and center, that is the number people optimize.
...
RevPAR stands for **Revenue Per Available Room**. The term [originated in hotel revenue management](https://en.wikipedia.org/wiki/RevPAR) decades ago, where it remains the industry's standard performance metric, and it was adopted directly by short-term rental operators when the discipline crossed over from hospitality. Whether the inventory is a hotel room or a vacation rental, the meaning is the same: total revenue divided by every available night in the period.
...
Sarah runs Boho Bungalow in San Diego. She came to RevFactor with a calendar that was filling but rates that were soft, and a listing leaving meaningful money on the table. We rebuilt the pricing strategy from the ground up. The result, summer-over-summer and according to RevFactor's own client data for the property: a **98.6% revenue lift**, with the largest ADR jump in the entire portfolio at **+39.7%**. The methodology behind moves like this is documented step by step in [The RevFactor Method](/blog/the-revfactor-method/). Occupancy did not collapse. ADR climbed. And RevPAR, the actual measure of what the property earned per night of available inventory, moved hard.
