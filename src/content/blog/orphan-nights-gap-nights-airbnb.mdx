...
- **Turnover gap:** a 0–1 night vacancy that sits between checkout and the next check-in, kept open because your operation needs it. Cleaning and laundry, sometimes a maintenance visit. It's a cost you chose.
...
<div class="rf-chart">
  <div class="rf-chart-header">
    <p class="kicker">AirROI · trailing twelve months</p>
    <h3>Same occupancy, 22 more chances to strand a night</h3>
    <p class="lede">Two markets, nearly identical occupancy, but a short average stay manufactures far more check-in events, and every one is a chance to leave an orphan.</p>
  </div>
  <div class="rf-chart-rows">
    <div class="rf-chart-row"><span class="rf-chart-label">Gatlinburg</span><span class="rf-chart-bar"><span class="rf-chart-fill" style="width:100%"></span></span><span class="rf-chart-value">~52</span></div>
    <div class="rf-chart-row"><span class="rf-chart-label">Scottsdale</span><span class="rf-chart-bar"><span class="rf-chart-fill comp" style="width:58%"></span></span><span class="rf-chart-value">~30</span></div>
  </div>
  <div class="rf-chart-legend">
    <span><span class="swatch cedar"></span>Gatlinburg · 3.4-night avg stay</span>
    <span><span class="swatch walnut"></span>Scottsdale · 5.9-night avg stay</span>
  </div>
</div>
...
<div class="rf-chart">
  <div class="rf-chart-header">
    ...
    <p class="lede">Property A keeps its vacancy in bookable blocks; Property B strands it as orphans. ADR is identical at $300. Every other number moves.</p>
  </div>
  <div class="rf-chart-rows">
...
<div class="rf-chart">
  <div class="rf-chart-header">
    ...
    <p class="lede">The average listing came in at a 25.0% orphan rate before management and settled at 11.9% after, and the portfolio-wide rate keeps falling year over year.</p>
  </div>
  <div class="rf-chart-rows">
