...
<figure class="rf-figure rf-figure-quote">
  <div class="rf-figure-frame">
    ...
    <blockquote class="rf-figure-overlay">
      <p>“The frameworks behind this article were developed across the 165+ properties RevFactor manages — 24 U.S. states, 56 markets, with a documented +18% RevPAR lift versus comp set.”</p>
      <cite>Federico Zimerman</cite>
    </blockquote>
  </div>
