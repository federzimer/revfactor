...
<figure class="rf-vendor-figure">
  ...
  <img loading="lazy" decoding="async"
       ...
       sizes="(min-width: 768px) 720px, 100vw"
       width="1280" height="750"
       alt="AvantStay homepage, premium full-service Airbnb property management for portfolio operators with 10+ premium units"
       style="width: 100%; height: auto; display: block; border-radius: 6px;" />
...
- Verify the current portfolio minimum, target markets, and the specifics of the design-and-capital scope in discovery. According to AvantStay's [owner page](https://www.avantstay.com/owners), checked September 14, 2026, the company now markets to individual homeowners, citing 2,500+ homeowners across 140+ markets and a 20% average revenue increase compared to traditional managers, a self-reported figure worth asking about
...
<script type="application/ld+json" set:html={JSON.stringify({
  ...
  "numberOfItems": 6,
  "itemListElement": [
    { "@type": "ListItem", "position": 1, "name": "Awning", "url": "https://awning.com/" },
    { "@type": "ListItem", "position": 2, "name": "AvantStay", "url": "https://www.avantstay.com/" },
    { "@type": "ListItem", "position": 3, "name": "Vacasa", "url": "https://www.vacasa.com/" },
    { "@type": "ListItem", "position": 4, "name": "Evolve", "url": "https://evolve.com/" },
    { "@type": "ListItem", "position": 5, "name": "iTrip", "url": "https://www.itrip.net/" },
    { "@type": "ListItem", "position": 6, "name": "Roami", "url": "https://www.roami.com/" }
  ]
})} />
