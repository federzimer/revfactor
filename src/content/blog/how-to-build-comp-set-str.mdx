...
This is the build sequence we run at RevFactor whenever a new property onboards, and the same sequence we run quarterly across the **198 listings in 67 markets and 24 U.S. states** on RevFactor's managed book, measured at the 2026-06-09 portfolio refresh and published on [the About page](/about/). Seven steps. Each step has a single job. Most operators try to skip Steps 1 and 5, which is why most comp sets read like neighbor lists.
...
Pull roughly 30–50 properties in most markets, adjusted up for high-density urban markets and down for thin-supply leisure markets. Use AirDNA, [PriceLabs](https://hello.pricelabs.co/pricing/) market dashboards, [Beyond](https://www.beyondpricing.com/plans), [Wheelhouse](https://www.usewheelhouse.com/pricing), or a manual Airbnb search filtered to your dates and guest count. Start wide so the seven filters do the narrowing. According to PriceLabs' own pricing page, a market dashboard runs from **$9.99 per dashboard per month** after the first free one, and Wheelhouse sells comp-set building as **Dynamic Sets at $12.99 per set per month**, both checked live on **August 24, 2026**. PriceLabs is the pricing engine RevFactor runs daily; Beyond and Wheelhouse are reasonable alternatives, and the three are compared feature by feature in [PriceLabs vs Wheelhouse vs a done-for-you service](/blog/pricelabs-vs-wheelhouse-vs-done-for-you/).
...
<div class="rf-scoreboard">
  <div class="rf-scoreboard-header">
    ...
    <p class="lede">Take one candidate property at a time and mark each filter PASS or FAIL. A candidate needs all seven to enter the set. Most fail at filter 3 or filter 7, and that is the sheet doing its job.</p>
  </div>
...
How full are the comps 30, 60, 90 days out? Pacing tells you whether the market is filling early or late. Weekly pricing decisions earn their money here. *More on this in our [ADR vs RevPAR](/blog/adr-vs-revpar-airbnb-hosts/) field guide.*
