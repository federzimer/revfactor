...
This is the build sequence we run at RevFactor whenever a new property onboards, and the same sequence we run quarterly across the 165+ properties managed under Blackbird Hospitality. Seven steps. Each step has a single job. Most operators try to skip Steps 1 and 5, which is why most comp sets read like neighbor lists.
...
This is the daily exercise RevFactor runs for STR operators across the country. Federico is also the founder of Blackbird Hospitality, a property management firm operating 165+ properties across 24 U.S. states and 56 markets. RevFactor applies the same frameworks to outside operators who keep their own property management.

If you want to walk through your comp set with someone who builds them daily, [start a conversation](/short-term-rental-consultant/) — or read the [case studies](/case-studies/) for what the discipline looks like in practice.
...
<div class="rf-author-bio">
  ...
  <div class="rf-author-content">
    ...
    <p>Federico Zimerman is the founder of [RevFactor](https://www.revfactor.io), a managed revenue management service for short-term rental hosts. He spent ten years in airline revenue management at American Airlines before applying that yield-management playbook to vacation rentals. Today, his strategies run daily across **165+ short-term rental properties in 24 U.S. states and 56 markets**, delivering a documented **+18% RevPAR lift vs. the comp set** across the portfolio.</p>
