...
description: "Discover, Strategise, Optimise — the RevFactor Method is a continuous three-phase revenue management process for short-term rental hosts. Federico Zimerman built the framework over a decade of airline yield management and applies it daily across 198 STRs to lift RevPAR vs. the comp set."
subhead: "A continuous three-phase operating rhythm — Discover · Strategise · Optimise — built from a decade of airline yield management and run daily across 198 short-term rentals."
pubDate: 2026-05-15
...
<div class="rf-chart">
  <div class="rf-chart-header">
    <p class="kicker">Portfolio data · 24 months · 198 listings · 24 U.S. states</p>
...
<figure class="rf-figure rf-figure-quote">
  <div class="rf-figure-frame">
    ...
    <blockquote class="rf-figure-overlay">
      <p>“Across 198 listings in 24 U.S. states, the Method averages +24% RevPAR vs. comp set. The work compounds where pacing discipline meets the right inventory rules.”</p>
      <cite>Federico Zimerman</cite>
    </blockquote>
  </div>
  <figcaption>Source: RevFactor managed portfolio, 24-month rolling average vs. submarket comp set, across 198 listings under active revenue management in 24 U.S. states.</figcaption>
</figure>
...
| **Documented outcome** | Whatever the defaults deliver | +24% RevPAR vs. comp set across 198 listings, 24 U.S. states |
...
<div class="rf-testimonial">
  ...
  <div class="author">
    ...
    <span class="metric">+24% RevPAR vs. comp set</span>
  </div>
</div>
