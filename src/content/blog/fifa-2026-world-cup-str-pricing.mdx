...
description: "Live AirROI + Booking.com data across all 11 U.S. host cities shows the 2026 FIFA World Cup is the first continental-scale pricing event the U.S. short-term rental market has ever absorbed. Most hosts are mispricing it."
...
image: "/photos/blog/fifa/stadium-final-night-2400.webp"
imageAlt: "Floodlights blazing across an empty modern football stadium at twilight just before kickoff, visualizing the 39-day demand window the 2026 FIFA World Cup creates across eleven U.S. host cities."
featured: true
readingTime: 14
faqs:
...
- **Dallas** hosts a semifinal at AT&T Stadium and is asking $623 per night on match-adjacent nights versus a $332 hotel median. That is 88% above hotels and the cleanest match-night premium in the dataset.
...
- **New York** hosts the Final at MetLife Stadium on July 19. Hosts in New York neighborhoods are asking $257 per night while local hotels are charging $449. That is a 43% discount to hotel rates on the most consequential night of the tournament.
...
- **Dallas** hosts a semifinal at AT&T Stadium. Hosts are asking $623 per night on match-adjacent nights. The local hotel median for the same nights is $332. **Short-term rentals are priced 88% above hotels.**
- **Atlanta** is also a semifinal host. Short-term rentals sit **64% above hotels** on the same comparison.
- **Miami** hosts the third-place match. The gap is **41%**.
- **Kansas City** sits **29%** above hotels, and it is the cleanest pricing-discipline story in the dataset. Kansas City is now running **129% above its three-year June/July transacted baseline** on match-adjacent nights, and the pricing is clearing. Match-night fill rate is **2.1× higher than non-match nights inside the same tournament window.**

### Where STRs are pricing below hotels

The picture reverses sharply in the four largest U.S. short-term rental markets.

- **New York** hosts the Final at MetLife Stadium on July 19. Hosts are asking $257 per night on match nights while local hotels are charging $449. That is a **43% discount to hotel rates**.
- **Boston** hosts a quarterfinal at Gillette Stadium. **28% below hotels.**
- **San Francisco Bay Area** sits **11% below.**
- **Los Angeles** hosts a quarterfinal at SoFi Stadium. **10% below hotels.**
...
- **Fort Lauderdale**, adjacent to Miami, is asking $558 per night. That is **94% above baseline.**
...
{/* NewsArticle schema removed 2026-06-22: the BlogPosting layout already
    emits headline, datePublished/dateModified, author (with proper @id ref
    to Person/Federico), publisher (with @id ref to Organization), and image.
    The inline block re-declared author/publisher as new entities (no @id),
    which orphaned them from the entity graph. If NewsArticle type is
    desired in the future, switch the layout's @type conditionally for this
    post, don't add a second block. */}
