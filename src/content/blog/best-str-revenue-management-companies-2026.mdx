...
<script type="application/ld+json" set:html={JSON.stringify({
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 11, "name": "Corzly", "url": "https://corzly.com/" }
  ]
})} />
