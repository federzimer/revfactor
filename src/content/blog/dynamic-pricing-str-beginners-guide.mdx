...
<figure class="rf-figure">
  <img src="/photos/blog/lake/dock-evening-2400.webp" alt="A solitary tree in an open field at golden hour — a visual cue for the patient pricing curve dynamic tools spend twelve months building" />
  <figcaption>Dynamic pricing is patient infrastructure — a curve a tool builds slowly across twelve months of demand.</figcaption>
</figure>
...
<figure class="rf-figure">
  <img src="/photos/blog/operations/notebook-coffee-2400.webp" alt="A laptop and external monitor on a sunlit wood desk — the operating surface where Airbnb hosts review pacing, comp set, and base rate weekly" />
