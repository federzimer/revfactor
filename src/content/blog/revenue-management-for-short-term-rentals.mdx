...
<figure class="rf-diagram" aria-label="Bar chart of average booked length of stay by month for Pigeon Forge, TN STR market">
  <svg viewBox="0 0 880 380" xmlns="http://www.w3.org/2000/svg" role="img" style="width:100%; height:auto; max-width:880px; display:block; margin:0 auto;">
    ...
    {/* Annotation: peak season — placed mid-chart upper area to avoid kicker collision */}
    <text x="178" y="56" font-family="Cormorant Garamond, Georgia, serif" font-size="14" font-style="italic" fill="#13342D">June–July: longer stays — design the LOS ladder for 5+</text>
    {/* Annotation: trough */}
