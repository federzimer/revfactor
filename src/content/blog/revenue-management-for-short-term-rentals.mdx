...
A few directional trends visible across the RevFactor portfolio entering 2026 — useful as benchmarks, not as forecasts to copy:

- **Booking windows have re-contracted.** Median lead time across the portfolio sits at ~32 days for non-event properties, down from ~48 days in 2023. The implication: shoulder-season prices have to be set 60–90 days ahead, not 30, or the price-sensitive segment has already moved on.
- **Mid-week ADR is climbing while weekend ADR holds flat** in roughly 60% of leisure markets we monitor. Remote-work travel is normalizing into a real demand layer, not a pandemic anomaly. Mid-week minimum-stay rules built in 2022 are quietly leaving revenue on the table in 2026.
- **Event-driven demand has gotten spikier, not flatter.** The peak of a major local event now over-indexes against the surrounding weeks by 40–60% (vs. ~25% pre-2023). This trend rewards earlier event pricing and tighter minimum-stay rules during the event window.
...
- **Direct-channel mix is recovering** as Airbnb fee structures and algorithm changes push experienced operators toward owned demand. Direct bookings sit at ~12–15% of total reservations across the portfolio in 2026, up from ~6% in 2023.
