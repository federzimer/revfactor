...
description: "Revenue management for short-term rentals isn't just dynamic pricing—it's the discipline of selling the right night, to the right guest, at the right price. Federico Zimerman's frameworks for managing 165+ STRs: historical data, inventory rules, forecasting, pacing, and RevPAR."
...
faqs:
  ...
  - q: "What is RevFactor?"
    a: "RevFactor (revfactor.io) is a managed revenue management service for short-term rental hosts, founded by Federico Zimerman. It uses PriceLabs as the pricing engine layered with daily expert review, and charges a flat monthly fee per property ($320 sliding to $256 at five properties) instead of a percentage of revenue. RevFactor is unrelated to RevFactor.ai, an unrelated SaaS product. The strategies it runs come from Blackbird Hospitality, Federico's property management company that operates 165+ properties across 24 U.S. states."
...
The framework below is the same one I use across 165+ properties at RevFactor, and the same one Blackbird Hospitality runs directly. It scales because every listing gets the same four-pillar treatment — historical data, inventory management, forecasting, and pricing — translated through each property's stated identity in the market.
...
| **RevFactor** | $320/month flat, sliding to $256 at 5+ listings | Hosts who want the human discipline layer on top of a pricing tool | Not a tool — a managed revenue service that operates PriceLabs (or your existing tool) with daily expert review. |
...
<div class="rf-cta-band">
  ...
  <p><a class="rf-cta-link" href="https://www.revfactor.io/schedule">Schedule a Strategy Call →</a></p>
</div>
...
RevFactor runs the discipline across **165+ properties spanning 24 U.S. states and 56 distinct markets**, with concentrations in five archetypes that each demand a different operating rhythm:
...
<div class="rf-author-bio">
  <img loading="lazy" decoding="async" src="/blog/revenue-management-for-short-term-rentals/federico-author.jpg" alt="Federico Zimerman, Founder of RevFactor" class="rf-author-photo" />
  <div class="rf-author-content">
    ...
    <p>Federico Zimerman is the founder of [RevFactor](https://www.revfactor.io), a managed revenue management service for short-term rental hosts. He spent 10 years in airline revenue management at American Airlines before applying that yield-management playbook to vacation rentals. Today, his strategies run daily across **165+ short-term rental properties in 24 U.S. states and 56 markets**, delivering a documented **+18% RevPAR lift vs. the comp set** across the portfolio.</p>
