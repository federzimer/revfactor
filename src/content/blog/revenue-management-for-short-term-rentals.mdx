...
<div class="rf-chart">
  ...
  <div class="rf-chart-rows">
    <div class="rf-chart-row">
      <span class="rf-chart-label">Q1 '24</span>
    ...
    <div class="rf-chart-row">
      <span class="rf-chart-label">Q2 '24</span>
    ...
    <div class="rf-chart-row">
      <span class="rf-chart-label">Q3 '24</span>
    ...
    <div class="rf-chart-row">
      <span class="rf-chart-label">Q4 '24</span>
...
<figure class="rf-diagram" aria-label="Bar chart of average booked length of stay by month for Pigeon Forge, TN STR market">
  <svg viewBox="0 0 880 380" xmlns="http://www.w3.org/2000/svg" role="img" style="width:100%; height:auto; max-width:880px; display:block; margin:0 auto;">
    ...
    <text x="40" y="28" font-family="Helvetica, Arial, sans-serif" font-size="11" font-weight="700" letter-spacing="2" fill="#3F261F">AVG BOOKED LENGTH OF STAY · PIGEON FORGE, TN · 12 MONTHS · AIRROI</text>
    {/* Y-axis grid */}
    ...
    <g font-family="JetBrains Mono, monospace" font-size="11" fill="#76574C" text-anchor="end">
      ...
      <text x="55" y="34">5.0 nights</text>
    </g>
    ...
    {/* 3.5 → y=117 h=203 */}
    {/* 4.0 → y=88  h=232 */}
    {/* 3.8 → y=99.6 ≈ 100 h=220 */}
    {/* 3.4 → y=122.8 ≈ 123 h=197 */}
    {/* 3.4 → 123 h=197 */}
    {/* 3.2 → y=134.4 ≈ 134 h=186 */}
    {/* 3.2 → 134 h=186 */}
    {/* 3.4 → 123 h=197 */}
    {/* 3.0 → y=146 h=174 */}
    {/* 2.8 → y=157.6 ≈ 158 h=162 */}
    {/* 3.4 → 123 h=197 */}
    {/* 3.2 → 134 h=186 */}
    <g>
    ...
    {/* Annotation: peak season */}
    <text x="178" y="60" font-family="Cormorant Garamond, Georgia, serif" font-size="14" font-style="italic" fill="#13342D">June–July: longer stays — design the LOS ladder for 5+</text>
    {/* Annotation: trough */}
    <text x="603" y="180" font-family="Cormorant Garamond, Georgia, serif" font-size="13" font-style="italic" fill="#76574C">Jan–Feb: shorter — drop minimum stay to 1–2 nights</text>
    {/* Legend */}
...
> *"We're handling the two most expensive assets people have: their property and their time."* — Federico Zimerman
